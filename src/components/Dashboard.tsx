...
import { Plus, BookOpen, MessageSquare, History, User, Users } from 'lucide-react';
  ...
  const handleAddChild = async (childData: Omit<Child, 'id' | 'created_at' | 'updated_at'>) => {
    ...
    try {
      ...
      if (editingChild) {
        ...
        toast({
          title: "Child profile updated successfully!",
      ...
      <div className="bg-white/80 backdrop-blur-sm border-b border-gray-200 p-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Manage child profiles and learning sessions</p>
          </div>
        ...
        <div className="mb-8">
          ...
          {children.length === 0 ? (
            <div className="bg-white rounded-xl shadow-sm p-8 text-center border border-gray-200">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">No Child Profiles Yet</h3>
              <p className="text-gray-600 mb-4">
                Create your first child profile to start personalized learning sessions.
              </p>
              <button
                onClick={() => setShowAddChild(true)}
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
            ...
            <p className="text-gray-600 mb-6">
              Are you sure you want to delete this child profile? This action cannot be undone and will also delete all associated conversations and data.
            </p>
